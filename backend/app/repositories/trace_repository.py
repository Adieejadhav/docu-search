"""
File: backend/app/repositories/trace_repository.py
Purpose: Owns database persistence for RAG answer traces.
"""
...
class TraceRepository:
    """PostgreSQL-backed repository for answer/retrieval traces."""
